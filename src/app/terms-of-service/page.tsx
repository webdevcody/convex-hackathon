...
export default function TermsOfServicePage() {
  return (
    <>
      <main className="container mx-auto max-w-4xl text-white flex flex-col gap-4 py-12">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Seibert Software Solutions, LLC, .
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to this hackathon site, accessible
              from{" "}
              <Link href="/" target="_blank">
                hackathon.webdevcody.com
              </Link>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: webdevcody@gmail.com</li>
        </ul>
      </main>
    </>
  );
